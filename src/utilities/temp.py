...
def debugger():
    ...
    for file in paths:
        ...
        corpus_file["double_brackets"] = noisy_double_brackets
    ...
    print("Total of sentences in the corpus = {}".format(total_sentences) + "\n")
    print("Total of clean sentences in the corpus = {}".format(amount_clean_sentences) + "\n")
    print("Total of noisy sentences in the corpus = {}".format(amount_noisy_sentences) + "\n")
    for file, clean_sentences in debugged_sentences.items():
